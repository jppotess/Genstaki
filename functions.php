...
function jp_scripts_and_styles() {
    ...
    // Styles
    wp_enqueue_style( 'site-styles', get_stylesheet_directory_uri() . '/dist/css/styles.min.css', array(), CHILD_THEME_VERSION );
    ...
    wp_enqueue_script('site-scripts', get_stylesheet_directory_uri() . '/dist/js/scripts.min.js', array('jquery'), '', true);
}
